...
<div class="signup-form">
    <form  method="POST">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="contactno" placeholder="Enter your Mobile Number" required="true" maxlength="11" pattern="[0-9]+">
        </div>
        <div class="form-group">
	...
	<div class="text-center">View Aready Inserted Data!!  <a href="index2.php">View</a></div>
</div>
</body>
</html>